...
public class AuctionTests {
        ...
        class BasicAuctionValidation {
                ...
                @Test
                public void testAuctionImagesEmpty() {
                        Auction validAuction1 = new Auction(
                                        6L,
        ...
        // ---------------------------------------------------------------------------
        @Nested
        class FixedTimeAuctionValidation {
                @Test
        ...
        // ---------------------------------------------------------------------------
        @Nested
        class EnglishAuctionValidation {
                @Test
        ...
        // ---------------------------------------------------------------------------
        @Nested
        class DescendingAuctionValidation {
                @Test
        ...
        // Auction validAuction2 = new Auction(2L, "Brand new bike, never used", "Bike",
        // "Good", 0.0f,
        // AuctionType.fixedtime, AuctionCategory.Toys, 2L, "bike.jpg",
        // parseDate("2025-01-01"),
        // new Time(34200000), 50.0f);

        // Auction validAuction3 = new Auction(4L, "Old book, great condition", "Book",
        // "Fair", 0.0f,
        // AuctionType.fixedtime, AuctionCategory.Books, 4L, "book.png",
        // parseDate("2026-06-01"),
        // new Time(34200000), 10.0f);
        ...
        // Auction invalidAuction1 = new Auction(
        // 3L,
        // "Table tennis table for sell, used by the best tennis table player in the
        // world and rank 94 on leetcode, Ma Lin",
        // "Table tennis table",
        // "Good",
        // 0.0f,
        // AuctionType.fixedtime,
        ...
        // // No auction name
        // Auction invalidAuction2 = new Auction(5L, "Description but no name", "",
        // "Good", 0.0f,
        // AuctionType.fixedtime,
        ...
        // Auction invalidAuction3 = new Auction(6L, "Old chair, great condition",
        // "Chair", "Good", 0.0f,
        ...
        // Auction invalidAuction4 = new Auction(7L, "New phone, unlocked", "Phone",
        // "Good", 0.0f,
        // AuctionType.fixedtime, AuctionCategory.Electronics, 7L, "phone.jpg",
        // parseDate("2015-01-01"), new Time(18200000), -10.0f);

        // // minimumAcceptablePrice too big
        // Auction invalidAuction5 = new Auction(8L, "Old laptop, great condition",
        // "Laptop", "Good", 0.0f,
        // AuctionType.fixedtime, AuctionCategory.Electronics, 8L, "laptop.jpg",
        // parseDate("2026-01-01"), new Time(19200000), 10000.1f);
        ...
        // 2L,
        // "Black flowers, good for a happy garden, really reccomended, please buy this
        // flowers.",
        // "Black flowers",
        // "Good",
        // 0.0f,
        ...
        // Auction invalidAuction1 = new Auction(
        // 4L,
        // "selling this really new iPhone, the best in the current market, if you think
        // it's old, then you are old",
        // "iPhone 3G",
        // "Good",
        // 0.0f,
        // AuctionType.english,
        ...
        // Auction validAuction2 = new Auction(
        // 2L,
        // "Beautiful orchids, great for a happy home, really reccomended, please buy
        // this orchids.",
        // "Orchids",
        // "Good",
        // 0.0f,
