  ...
  return (
    <>
      <div className="flex flex-col h-[80vh] justify-center items-center w-full">
        <div className="mb-4 text-3xl md:text-7xl font-extrabold">
          <h1>Sell and buy with just a few clicks. </h1>
        </div>
        <div className="mb-4 italic ml-8 text-xl md:text-4xl">
          <p>
            It&apos;s easy and fast to use. Are you ready? Let&apos;s get
            started!
          </p>
        </div>
        <Link href="/home">
