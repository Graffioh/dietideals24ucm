...
export function isValidHour(value) {
  ...
  export function getDateByType(date, type) {
    switch (type) {
      case "minutes":
        return getValidMinuteOrSecond(String(date ? date.getMinutes() : ""));
      case "seconds":
        return getValidMinuteOrSecond(String(date ? date.getSeconds() : ""));
      case "hours":
        return getValidHour(String(date ? date.getHours() : ""));
      default:
        return "00";
    }
  }
